...
show_help() {
	...
	Available options:
	  ...
	  ${c_green}--localbkp-clear${c_reset}      - clear ${c_red}localbkp${c_reset} directory
	  ${c_green}--lokalbkp-check${c_reset}      - check ${c_red}localbkp${c_reset} directory and print if there are any files
	  ...
	  ${c_green}--restore-clear${c_reset}       - delete all files from the ${c_red}restore${c_reset} directory
